...
\begin{enumerate}
	\item The metric advice function of the client might not work properly: the answer of the server can be blocked by a firewall or due to restrictions of the network router the client application is working behind. The POST request of the server is expected on port 6060.
\end{enumerate}
